    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            iconView.leadingAnchor.constraint(equalTo: leadingAnchor,
                                              constant: 20),
            iconView.bottomAnchor.constraint(equalTo: divider.topAnchor,
                                             constant: -10),
...
//Assets
    private func setupLayers() {
        ...
        bottomShadow.startPoint = CGPoint(x: 0,
                                          y: 0)
        bottomShadow.endPoint   = CGPoint(x: 0,
                                          y: 1)
...
final class LibraryEmptyCell: UICollectionViewCell {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            iconView.centerXAnchor.constraint(equalTo:
                                                contentView.centerXAnchor),
            iconView.centerYAnchor.constraint(equalTo:
            ...
            messageLabel.topAnchor.constraint(equalTo:
                                              ...
                                              constant: 12),
            messageLabel.centerXAnchor.constraint(equalTo:
                                                    contentView.centerXAnchor),

            subLabel.topAnchor.constraint(equalTo:
                                            messageLabel.bottomAnchor,
                                          constant: 4),
            subLabel.centerXAnchor.constraint(equalTo:
                                                contentView.centerXAnchor)
        ])
    }
}
